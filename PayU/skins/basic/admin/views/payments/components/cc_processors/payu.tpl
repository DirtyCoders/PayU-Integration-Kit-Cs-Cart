...
<div class="form-field">
	<label for="salt">{$lang.salt}:</label>
	<input type="text" name="payment_data[processor_params][salt]" id="salt" value="{$processor_params.salt}" class="input-text" />
</div>

<div class="form-field">
	<label for="item_name">{$lang.payu_item_name}:</label>
